...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(122957931785154541307)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(81973578366535170960)
,p_plug_template_id=>wwv_flow_imp.id(122957931785154541307)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(81973578804441170960)
,p_plug_template_id=>wwv_flow_imp.id(122957931785154541307)
,p_name=>'Tabs'
