...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(122957939460350541311)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(81973599315291170971)
,p_plug_template_id=>wwv_flow_imp.id(122957939460350541311)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(81973599842327170971)
,p_plug_template_id=>wwv_flow_imp.id(122957939460350541311)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(81973600356143170972)
,p_plug_template_id=>wwv_flow_imp.id(122957939460350541311)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(81973600807421170972)
,p_plug_template_id=>wwv_flow_imp.id(122957939460350541311)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(81973601339236170972)
,p_plug_template_id=>wwv_flow_imp.id(122957939460350541311)
