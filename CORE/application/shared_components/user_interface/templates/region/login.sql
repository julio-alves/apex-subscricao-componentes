...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(122957916785641541301)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(81973538474870170937)
,p_plug_template_id=>wwv_flow_imp.id(122957916785641541301)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(81973538919586170938)
,p_plug_template_id=>wwv_flow_imp.id(122957916785641541301)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(81973539480671170938)
,p_plug_template_id=>wwv_flow_imp.id(122957916785641541301)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(81973539977089170938)
,p_plug_template_id=>wwv_flow_imp.id(122957916785641541301)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(81973540402185170938)
,p_plug_template_id=>wwv_flow_imp.id(122957916785641541301)
,p_name=>'Sub Regions'
