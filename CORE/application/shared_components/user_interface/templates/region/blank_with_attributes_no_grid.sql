...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(122957856784143541272)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(81973384533533170846)
,p_plug_template_id=>wwv_flow_imp.id(122957856784143541272)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(81973385089658170846)
,p_plug_template_id=>wwv_flow_imp.id(122957856784143541272)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(81973385580389170846)
,p_plug_template_id=>wwv_flow_imp.id(122957856784143541272)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(81973386011881170847)
,p_plug_template_id=>wwv_flow_imp.id(122957856784143541272)
,p_name=>'Sub Regions'
