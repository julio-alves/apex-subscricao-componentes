...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(122957855441012541272)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(81973380678620170844)
,p_plug_template_id=>wwv_flow_imp.id(122957855441012541272)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(81973381133042170844)
,p_plug_template_id=>wwv_flow_imp.id(122957855441012541272)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(81973381650280170844)
,p_plug_template_id=>wwv_flow_imp.id(122957855441012541272)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(81973382123879170845)
,p_plug_template_id=>wwv_flow_imp.id(122957855441012541272)
,p_name=>'Sub Regions'
