...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(122957850161310541266)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(81973368875785170837)
,p_plug_template_id=>wwv_flow_imp.id(122957850161310541266)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(81973369382498170837)
,p_plug_template_id=>wwv_flow_imp.id(122957850161310541266)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(81973369848425170838)
,p_plug_template_id=>wwv_flow_imp.id(122957850161310541266)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(81973370392265170838)
,p_plug_template_id=>wwv_flow_imp.id(122957850161310541266)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(81973370840610170838)
,p_plug_template_id=>wwv_flow_imp.id(122957850161310541266)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(81973371374625170838)
,p_plug_template_id=>wwv_flow_imp.id(122957850161310541266)
,p_name=>'Sub Regions'
