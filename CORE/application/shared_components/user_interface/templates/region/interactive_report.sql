...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(122957912209166541299)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(81973527035236170930)
,p_plug_template_id=>wwv_flow_imp.id(122957912209166541299)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(81973527584017170931)
,p_plug_template_id=>wwv_flow_imp.id(122957912209166541299)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(81973528007743170931)
,p_plug_template_id=>wwv_flow_imp.id(122957912209166541299)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(81973528555051170931)
,p_plug_template_id=>wwv_flow_imp.id(122957912209166541299)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(81973529058716170932)
,p_plug_template_id=>wwv_flow_imp.id(122957912209166541299)
,p_name=>'Sub Regions'
