...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(122957914273501541300)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(81973531656439170933)
,p_plug_template_id=>wwv_flow_imp.id(122957914273501541300)
,p_name=>'Item'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(81973532137142170934)
,p_plug_template_id=>wwv_flow_imp.id(122957914273501541300)
,p_name=>'Button End'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(81973532681360170934)
,p_plug_template_id=>wwv_flow_imp.id(122957914273501541300)
,p_name=>'Button Start'
