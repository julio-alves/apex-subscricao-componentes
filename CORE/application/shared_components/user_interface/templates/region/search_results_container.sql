...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(122957919305676541302)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(81973544287142170941)
,p_plug_template_id=>wwv_flow_imp.id(122957919305676541302)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(81973544757348170941)
,p_plug_template_id=>wwv_flow_imp.id(122957919305676541302)
,p_name=>'Search Field'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(81973545232464170941)
,p_plug_template_id=>wwv_flow_imp.id(122957919305676541302)
,p_name=>'Sub Regions'
