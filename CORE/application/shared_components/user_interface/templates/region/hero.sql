...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(122957888756930541288)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(81973467197965170891)
,p_plug_template_id=>wwv_flow_imp.id(122957888756930541288)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(81973467648556170892)
,p_plug_template_id=>wwv_flow_imp.id(122957888756930541288)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(81973468103030170892)
,p_plug_template_id=>wwv_flow_imp.id(122957888756930541288)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(81973468649196170892)
,p_plug_template_id=>wwv_flow_imp.id(122957888756930541288)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(81973469152054170892)
,p_plug_template_id=>wwv_flow_imp.id(122957888756930541288)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false
