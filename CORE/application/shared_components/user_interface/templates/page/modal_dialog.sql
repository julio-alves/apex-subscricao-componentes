...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(122957840064427541252)
,p_theme_id=>42
,p_name=>'Modal Dialog'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(81973340245691170819)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(81973340737006170819)
,p_page_template_id=>wwv_flow_imp.id(122957840064427541252)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(81973341270088170819)
,p_page_template_id=>wwv_flow_imp.id(122957840064427541252)
