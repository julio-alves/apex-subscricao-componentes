...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(122957830066803541247)
,p_theme_id=>42
,p_name=>'Login'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(81973313340810170804)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(81973313879491170804)
,p_page_template_id=>wwv_flow_imp.id(122957830066803541247)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(81973314301134170804)
,p_page_template_id=>wwv_flow_imp.id(122957830066803541247)
,p_name=>'Body Header'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(81973314840359170805)
,p_page_template_id=>wwv_flow_imp.id(122957830066803541247)
,p_name=>'Body Footer'
