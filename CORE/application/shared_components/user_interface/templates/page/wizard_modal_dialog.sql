...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(122957848681363541265)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(81973364098118170830)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(81973364543248170830)
,p_page_template_id=>wwv_flow_imp.id(122957848681363541265)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(81973365023213170831)
,p_page_template_id=>wwv_flow_imp.id(122957848681363541265)
