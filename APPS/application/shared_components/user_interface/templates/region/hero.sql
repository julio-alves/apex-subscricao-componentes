...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(81999736595706452969)
,p_layout=>'TABLE'
...
,p_reference_id=>204933259018610074681
,p_translate_this_template=>'N'
);
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(82405245471982466744)
,p_plug_template_id=>wwv_flow_imp.id(81999736595706452969)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(82405245900603466744)
,p_plug_template_id=>wwv_flow_imp.id(81999736595706452969)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(82405246423293466745)
,p_plug_template_id=>wwv_flow_imp.id(81999736595706452969)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(82405246916835466745)
,p_plug_template_id=>wwv_flow_imp.id(81999736595706452969)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(82405247470038466745)
,p_plug_template_id=>wwv_flow_imp.id(81999736595706452969)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false
