...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(81999710127075452957)
,p_layout=>'TABLE'
...
,p_reference_id=>204933232720621074668
,p_translate_this_template=>'N'
);
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(82405177448016466703)
,p_plug_template_id=>wwv_flow_imp.id(81999710127075452957)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(82405177996918466704)
,p_plug_template_id=>wwv_flow_imp.id(81999710127075452957)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(82405178409527466704)
,p_plug_template_id=>wwv_flow_imp.id(81999710127075452957)
,p_name=>'Sub Regions'
