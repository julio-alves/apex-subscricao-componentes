...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(81999779868848452988)
,p_layout=>'TABLE'
...
,p_reference_id=>204933302046834074700
,p_translate_this_template=>'N'
);
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(82405356578521466811)
,p_plug_template_id=>wwv_flow_imp.id(81999779868848452988)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(82405357071995466811)
,p_plug_template_id=>wwv_flow_imp.id(81999779868848452988)
,p_name=>'Tabs'
