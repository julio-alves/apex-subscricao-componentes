...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(81999740074786452971)
,p_layout=>'TABLE'
...
,p_reference_id=>204933262460912074683
,p_translate_this_template=>'N'
);
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(82405252978422466749)
,p_plug_template_id=>wwv_flow_imp.id(81999740074786452971)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(82405253493598466749)
,p_plug_template_id=>wwv_flow_imp.id(81999740074786452971)
,p_name=>'Sub Regions'
