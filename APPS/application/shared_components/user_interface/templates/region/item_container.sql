...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(81999762189877452980)
,p_layout=>'TABLE'
...
,p_reference_id=>204933284535181074693
,p_translate_this_template=>'N'
);
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(82405309969042466784)
,p_plug_template_id=>wwv_flow_imp.id(81999762189877452980)
,p_name=>'Item'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(82405310464851466784)
,p_plug_template_id=>wwv_flow_imp.id(81999762189877452980)
,p_name=>'Button End'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(82405310905833466784)
,p_plug_template_id=>wwv_flow_imp.id(81999762189877452980)
,p_name=>'Button Start'
