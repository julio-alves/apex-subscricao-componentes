...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(81999666874800452936)
,p_theme_id=>422
,p_name=>'Drawer'
...
,p_reference_id=>204933189780708074625
);
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(82405062141275466636)
,p_page_template_id=>wwv_flow_imp.id(81999666874800452936)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(82405062644052466637)
,p_page_template_id=>wwv_flow_imp.id(81999666874800452936)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(82405063163067466637)
,p_page_template_id=>wwv_flow_imp.id(81999666874800452936)
