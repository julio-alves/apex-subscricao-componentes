...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(81999677547658452942)
,p_theme_id=>422
,p_name=>'Login'
...
,p_reference_id=>204933200328483074640
);
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(82405091445043466654)
,p_page_template_id=>wwv_flow_imp.id(81999677547658452942)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(82405091942899466654)
,p_page_template_id=>wwv_flow_imp.id(81999677547658452942)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(82405092447273466655)
,p_page_template_id=>wwv_flow_imp.id(81999677547658452942)
,p_name=>'Body Header'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(82405092951388466655)
,p_page_template_id=>wwv_flow_imp.id(81999677547658452942)
,p_name=>'Body Footer'
