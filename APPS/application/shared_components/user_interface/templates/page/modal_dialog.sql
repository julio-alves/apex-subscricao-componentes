...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(81999687757474452947)
,p_theme_id=>422
,p_name=>'Modal Dialog'
...
,p_reference_id=>204933210326107074645
);
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(82405118340032466670)
,p_page_template_id=>wwv_flow_imp.id(81999687757474452947)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(82405118866273466670)
,p_page_template_id=>wwv_flow_imp.id(81999687757474452947)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(82405119370813466670)
,p_page_template_id=>wwv_flow_imp.id(81999687757474452947)
