prompt --application/shared_components/plugins/template_component/theme_422_avatar
begin
--   Manifest
--     PLUGIN: THEME_422$AVATAR
--   Manifest End
...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(81999845868684453022)
,p_plugin_type=>'TEMPLATE COMPONENT'
,p_theme_id=>nvl(wwv_flow_application_install.get_theme_id, '422')
,p_name=>'THEME_422$AVATAR'
,p_display_name=>'Avatar'
,p_supported_component_types=>'PARTIAL'
,p_image_prefix => nvl(wwv_flow_application_install.get_static_plugin_file_prefix('TEMPLATE COMPONENT','THEME_422$AVATAR'),'')
...
,p_reference_id=>204933367440071074750
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(82405504839842466913)
,p_plugin_id=>wwv_flow_imp.id(81999845868684453022)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(82405505317016466914)
,p_plugin_attribute_id=>wwv_flow_imp.id(82405504839842466913)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'IMAGE'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(82405505987843466914)
,p_plugin_attribute_id=>wwv_flow_imp.id(82405504839842466913)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(82405506593715466917)
,p_plugin_attribute_id=>wwv_flow_imp.id(82405504839842466913)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(82405507192912466918)
,p_plugin_id=>wwv_flow_imp.id(81999845868684453022)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(82405504839842466913)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(82405507692932466919)
,p_plugin_id=>wwv_flow_imp.id(81999845868684453022)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(82405508133442466919)
,p_plugin_id=>wwv_flow_imp.id(81999845868684453022)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(82405508611371466920)
,p_plugin_id=>wwv_flow_imp.id(81999845868684453022)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(82405509182836466920)
,p_plugin_id=>wwv_flow_imp.id(81999845868684453022)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(82405509699261466921)
,p_plugin_attribute_id=>wwv_flow_imp.id(82405509182836466920)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(82405510201512466921)
,p_plugin_attribute_id=>wwv_flow_imp.id(82405509182836466920)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(82405510819920466922)
,p_plugin_attribute_id=>wwv_flow_imp.id(82405509182836466920)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(82405511471665466922)
,p_plugin_attribute_id=>wwv_flow_imp.id(82405509182836466920)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(82405512019708466923)
,p_plugin_id=>wwv_flow_imp.id(81999845868684453022)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(82405512587557466923)
,p_plugin_attribute_id=>wwv_flow_imp.id(82405512019708466923)
,p_display_sequence=>10
,p_display_value=>'Extra Extra Small'
,p_return_value=>'t-Avatar--xxs'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(82405513155200466924)
,p_plugin_attribute_id=>wwv_flow_imp.id(82405512019708466923)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(82405513722567466924)
,p_plugin_attribute_id=>wwv_flow_imp.id(82405512019708466923)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(82405514348736466925)
,p_plugin_attribute_id=>wwv_flow_imp.id(82405512019708466923)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(82405514990462466925)
,p_plugin_attribute_id=>wwv_flow_imp.id(82405512019708466923)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(82405515524117466926)
,p_plugin_attribute_id=>wwv_flow_imp.id(82405512019708466923)
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(82405516149891466926)
,p_plugin_attribute_id=>wwv_flow_imp.id(82405512019708466923)
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(82405516728865466927)
,p_plugin_id=>wwv_flow_imp.id(81999845868684453022)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(288733264358705641528)
,p_plugin_id=>wwv_flow_imp.id(81999845868684453022)
,p_name=>'Link'
,p_static_id=>'LINK'
,p_display_sequence=>10
