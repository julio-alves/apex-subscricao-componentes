prompt --application/shared_components/plugins/template_component/theme_422_button
begin
--   Manifest
--     PLUGIN: THEME_422$BUTTON
--   Manifest End
...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(81999861374900453042)
,p_plugin_type=>'TEMPLATE COMPONENT'
,p_theme_id=>nvl(wwv_flow_application_install.get_theme_id, '422')
,p_name=>'THEME_422$BUTTON'
,p_display_name=>'Button'
,p_image_prefix => nvl(wwv_flow_application_install.get_static_plugin_file_prefix('TEMPLATE COMPONENT','THEME_422$BUTTON'),'')
...
,p_reference_id=>204933382691723074791
,p_version_scn=>76331028
,p_subscribe_plugin_settings=>true
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(82405528843038466947)
,p_plugin_id=>wwv_flow_imp.id(81999861374900453042)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(82405529319128466949)
,p_plugin_id=>wwv_flow_imp.id(81999861374900453042)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(82405529876581466950)
,p_plugin_id=>wwv_flow_imp.id(81999861374900453042)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(82405530384533466950)
,p_plugin_id=>wwv_flow_imp.id(81999861374900453042)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(82405530831513466950)
,p_plugin_id=>wwv_flow_imp.id(81999861374900453042)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(82405531350578466951)
,p_plugin_id=>wwv_flow_imp.id(81999861374900453042)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(82405531836416466951)
,p_plugin_id=>wwv_flow_imp.id(81999861374900453042)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(82405532341326466952)
,p_plugin_id=>wwv_flow_imp.id(81999861374900453042)
,p_attribute_scope=>'COMPONENT'
