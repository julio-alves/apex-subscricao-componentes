prompt --application/shared_components/plugins/template_component/theme_422_media_list
begin
--   Manifest
--     PLUGIN: THEME_422$MEDIA_LIST
--   Manifest End
...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(7110790523247832)
,p_plugin_type=>'TEMPLATE COMPONENT'
,p_theme_id=>nvl(wwv_flow_application_install.get_theme_id, '422')
,p_name=>'THEME_422$MEDIA_LIST'
,p_display_name=>'Media List'
,p_supported_component_types=>'PARTIAL:REPORT'
,p_image_prefix => nvl(wwv_flow_application_install.get_static_plugin_file_prefix('TEMPLATE COMPONENT','THEME_422$MEDIA_LIST'),'')
...
,p_reference_id=>204933422522446074852
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(166162009318929850077)
,p_plugin_id=>wwv_flow_imp.id(7110790523247832)
,p_title=>'Avatar'
,p_display_sequence=>10
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(166162008763917850076)
,p_plugin_id=>wwv_flow_imp.id(7110790523247832)
,p_title=>'Badge'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412804053914261853)
,p_plugin_id=>wwv_flow_imp.id(7110790523247832)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412804631805261853)
,p_plugin_id=>wwv_flow_imp.id(7110790523247832)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412805053167261854)
,p_plugin_id=>wwv_flow_imp.id(7110790523247832)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412805560921261854)
,p_plugin_id=>wwv_flow_imp.id(7110790523247832)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412806116269261855)
,p_plugin_id=>wwv_flow_imp.id(7110790523247832)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(412805053167261854)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(166162009318929850077)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412806581513261856)
,p_plugin_attribute_id=>wwv_flow_imp.id(412806116269261855)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412807203294261857)
,p_plugin_attribute_id=>wwv_flow_imp.id(412806116269261855)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412807803516261857)
,p_plugin_attribute_id=>wwv_flow_imp.id(412806116269261855)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412808360905261858)
,p_plugin_id=>wwv_flow_imp.id(7110790523247832)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(412806116269261855)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412808940477261859)
,p_plugin_id=>wwv_flow_imp.id(7110790523247832)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412809424053261859)
,p_plugin_id=>wwv_flow_imp.id(7110790523247832)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412809926880261860)
,p_plugin_id=>wwv_flow_imp.id(7110790523247832)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412810345996261860)
,p_plugin_id=>wwv_flow_imp.id(7110790523247832)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412810864677261861)
,p_plugin_attribute_id=>wwv_flow_imp.id(412810345996261860)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412811481091261861)
,p_plugin_attribute_id=>wwv_flow_imp.id(412810345996261860)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412812132354261862)
,p_plugin_attribute_id=>wwv_flow_imp.id(412810345996261860)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412812689019261862)
,p_plugin_attribute_id=>wwv_flow_imp.id(412810345996261860)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412813306489261863)
,p_plugin_id=>wwv_flow_imp.id(7110790523247832)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'RAW'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(412805560921261854)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_attribute_group_id=>wwv_flow_imp.id(166162008763917850076)
,p_help_text=>'Enter a value for the badge label or select a source column from the quick pick options.'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412813758946261865)
,p_plugin_id=>wwv_flow_imp.id(7110790523247832)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412814276528261865)
,p_plugin_id=>wwv_flow_imp.id(7110790523247832)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412814795693261866)
,p_plugin_id=>wwv_flow_imp.id(7110790523247832)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412815251227261866)
,p_plugin_id=>wwv_flow_imp.id(7110790523247832)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412815757465261867)
,p_plugin_id=>wwv_flow_imp.id(7110790523247832)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412816270019261869)
,p_plugin_attribute_id=>wwv_flow_imp.id(412815757465261867)
,p_display_sequence=>10
,p_display_value=>'Subtle'
,p_return_value=>'t-Badge--subtle'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412816930821261869)
,p_plugin_attribute_id=>wwv_flow_imp.id(412815757465261867)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412817530368261871)
,p_plugin_id=>wwv_flow_imp.id(7110790523247832)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412817952351261873)
,p_plugin_attribute_id=>wwv_flow_imp.id(412817530368261871)
,p_display_sequence=>10
,p_display_value=>'Rounded'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412818584504261874)
,p_plugin_attribute_id=>wwv_flow_imp.id(412817530368261871)
,p_display_sequence=>20
,p_display_value=>'Circular'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412819187638261874)
,p_plugin_attribute_id=>wwv_flow_imp.id(412817530368261871)
,p_display_sequence=>30
,p_display_value=>'Square'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412819802364261875)
,p_plugin_id=>wwv_flow_imp.id(7110790523247832)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412820264570261876)
,p_plugin_attribute_id=>wwv_flow_imp.id(412819802364261875)
,p_display_sequence=>10
,p_display_value=>'2 Column Grid'
,p_return_value=>'t-MediaList--cols t-MediaList--2cols'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412820904754261876)
,p_plugin_attribute_id=>wwv_flow_imp.id(412819802364261875)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412821521341261882)
,p_plugin_attribute_id=>wwv_flow_imp.id(412819802364261875)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412822051911261883)
,p_plugin_attribute_id=>wwv_flow_imp.id(412819802364261875)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412822700808261884)
,p_plugin_attribute_id=>wwv_flow_imp.id(412819802364261875)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412823339148261885)
,p_plugin_id=>wwv_flow_imp.id(7110790523247832)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412823824700261886)
,p_plugin_attribute_id=>wwv_flow_imp.id(412823339148261885)
,p_display_sequence=>10
,p_display_value=>'Large'
,p_return_value=>'t-MediaList--large force-fa-lg'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412824398258261886)
,p_plugin_id=>wwv_flow_imp.id(7110790523247832)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(206740754897679352967)
,p_plugin_id=>wwv_flow_imp.id(7110790523247832)
,p_name=>'Link'
,p_static_id=>'LINK'
,p_display_sequence=>10
