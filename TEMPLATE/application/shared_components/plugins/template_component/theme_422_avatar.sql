...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(7054009399247757)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412712980557261648)
,p_plugin_id=>wwv_flow_imp.id(7054009399247757)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412713457731261649)
,p_plugin_attribute_id=>wwv_flow_imp.id(412712980557261648)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'IMAGE'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412714128558261649)
,p_plugin_attribute_id=>wwv_flow_imp.id(412712980557261648)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412714734430261652)
,p_plugin_attribute_id=>wwv_flow_imp.id(412712980557261648)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412715333627261653)
,p_plugin_id=>wwv_flow_imp.id(7054009399247757)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(412712980557261648)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412715833647261654)
,p_plugin_id=>wwv_flow_imp.id(7054009399247757)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412716274157261654)
,p_plugin_id=>wwv_flow_imp.id(7054009399247757)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412716752086261655)
,p_plugin_id=>wwv_flow_imp.id(7054009399247757)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412717323551261655)
,p_plugin_id=>wwv_flow_imp.id(7054009399247757)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412717839976261656)
,p_plugin_attribute_id=>wwv_flow_imp.id(412717323551261655)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412718342227261656)
,p_plugin_attribute_id=>wwv_flow_imp.id(412717323551261655)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412718960635261657)
,p_plugin_attribute_id=>wwv_flow_imp.id(412717323551261655)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412719612380261657)
,p_plugin_attribute_id=>wwv_flow_imp.id(412717323551261655)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412720160423261658)
,p_plugin_id=>wwv_flow_imp.id(7054009399247757)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412720728272261658)
,p_plugin_attribute_id=>wwv_flow_imp.id(412720160423261658)
,p_display_sequence=>10
,p_display_value=>'Extra Extra Small'
,p_return_value=>'t-Avatar--xxs'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412721295915261659)
,p_plugin_attribute_id=>wwv_flow_imp.id(412720160423261658)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412721863282261659)
,p_plugin_attribute_id=>wwv_flow_imp.id(412720160423261658)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412722489451261660)
,p_plugin_attribute_id=>wwv_flow_imp.id(412720160423261658)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412723131177261660)
,p_plugin_attribute_id=>wwv_flow_imp.id(412720160423261658)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412723664832261661)
,p_plugin_attribute_id=>wwv_flow_imp.id(412720160423261658)
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412724290606261661)
,p_plugin_attribute_id=>wwv_flow_imp.id(412720160423261658)
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412724869580261662)
,p_plugin_id=>wwv_flow_imp.id(7054009399247757)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(206740472499420436263)
,p_plugin_id=>wwv_flow_imp.id(7054009399247757)
,p_name=>'Link'
,p_static_id=>'LINK'
,p_display_sequence=>10
