...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(7063282280247769)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412727402148261666)
,p_plugin_id=>wwv_flow_imp.id(7063282280247769)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412727872991261667)
,p_plugin_id=>wwv_flow_imp.id(7063282280247769)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412728344355261667)
,p_plugin_id=>wwv_flow_imp.id(7063282280247769)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412728848706261668)
,p_plugin_id=>wwv_flow_imp.id(7063282280247769)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412729368345261668)
,p_plugin_id=>wwv_flow_imp.id(7063282280247769)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412729881541261669)
,p_plugin_id=>wwv_flow_imp.id(7063282280247769)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412730423277261669)
,p_plugin_attribute_id=>wwv_flow_imp.id(412729881541261669)
,p_display_sequence=>10
,p_display_value=>'Subtle'
,p_return_value=>'t-Badge--subtle'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412731024116261670)
,p_plugin_attribute_id=>wwv_flow_imp.id(412729881541261669)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412731600861261671)
,p_plugin_id=>wwv_flow_imp.id(7063282280247769)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412732137885261672)
,p_plugin_attribute_id=>wwv_flow_imp.id(412731600861261671)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412732652006261673)
,p_plugin_attribute_id=>wwv_flow_imp.id(412731600861261671)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412733327661261676)
,p_plugin_attribute_id=>wwv_flow_imp.id(412731600861261671)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412733889098261678)
,p_plugin_id=>wwv_flow_imp.id(7063282280247769)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412734359370261678)
,p_plugin_attribute_id=>wwv_flow_imp.id(412733889098261678)
,p_display_sequence=>10
,p_display_value=>'Small'
,p_return_value=>'t-Badge--sm'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412734954861261679)
,p_plugin_attribute_id=>wwv_flow_imp.id(412733889098261678)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412735582599261680)
,p_plugin_attribute_id=>wwv_flow_imp.id(412733889098261678)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(206451922221215424744)
,p_plugin_id=>wwv_flow_imp.id(7063282280247769)
,p_name=>'Link'
,p_static_id=>'LINK'
,p_display_sequence=>10
