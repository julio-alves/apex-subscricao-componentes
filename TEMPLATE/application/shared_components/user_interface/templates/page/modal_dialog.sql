...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(6895898189247682)
,p_theme_id=>422
,p_name=>'Modal Dialog'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(412326480747261405)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(412327006988261405)
,p_page_template_id=>wwv_flow_imp.id(6895898189247682)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(412327511528261405)
,p_page_template_id=>wwv_flow_imp.id(6895898189247682)
