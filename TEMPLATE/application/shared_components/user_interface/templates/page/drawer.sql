...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(6875015515247671)
,p_theme_id=>422
,p_name=>'Drawer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(412270281990261371)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(412270784767261372)
,p_page_template_id=>wwv_flow_imp.id(6875015515247671)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(412271303782261372)
,p_page_template_id=>wwv_flow_imp.id(6875015515247671)
