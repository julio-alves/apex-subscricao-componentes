...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(6904504708247686)
,p_theme_id=>422
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(412350202303261418)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(412350733921261418)
,p_page_template_id=>wwv_flow_imp.id(6904504708247686)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(412351203840261418)
,p_page_template_id=>wwv_flow_imp.id(6904504708247686)
