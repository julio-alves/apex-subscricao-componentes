...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(6912628545247690)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(412370592643261430)
,p_plug_template_id=>wwv_flow_imp.id(6912628545247690)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(412371108969261430)
,p_plug_template_id=>wwv_flow_imp.id(6912628545247690)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(412371640686261430)
,p_plug_template_id=>wwv_flow_imp.id(6912628545247690)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(412372083427261431)
,p_plug_template_id=>wwv_flow_imp.id(6912628545247690)
,p_name=>'Sub Regions'
