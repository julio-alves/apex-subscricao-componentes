...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(6911232382247689)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(412366711985261428)
,p_plug_template_id=>wwv_flow_imp.id(6911232382247689)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(412367173599261428)
,p_plug_template_id=>wwv_flow_imp.id(6911232382247689)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(412367659577261428)
,p_plug_template_id=>wwv_flow_imp.id(6911232382247689)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(412368175196261428)
,p_plug_template_id=>wwv_flow_imp.id(6911232382247689)
,p_name=>'Sub Regions'
