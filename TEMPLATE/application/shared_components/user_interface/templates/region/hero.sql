...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(6944736421247704)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(412453612697261479)
,p_plug_template_id=>wwv_flow_imp.id(6944736421247704)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(412454041318261479)
,p_plug_template_id=>wwv_flow_imp.id(6944736421247704)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(412454564008261480)
,p_plug_template_id=>wwv_flow_imp.id(6944736421247704)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(412455057550261480)
,p_plug_template_id=>wwv_flow_imp.id(6944736421247704)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(412455610753261480)
,p_plug_template_id=>wwv_flow_imp.id(6944736421247704)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false
