...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(6948215501247706)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(412461119137261484)
,p_plug_template_id=>wwv_flow_imp.id(6948215501247706)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(412461634313261484)
,p_plug_template_id=>wwv_flow_imp.id(6948215501247706)
,p_name=>'Sub Regions'
