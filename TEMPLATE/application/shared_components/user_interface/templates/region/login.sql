...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(6972832964247716)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(412524933010261523)
,p_plug_template_id=>wwv_flow_imp.id(6972832964247716)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(412525424595261523)
,p_plug_template_id=>wwv_flow_imp.id(6972832964247716)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(412525918875261523)
,p_plug_template_id=>wwv_flow_imp.id(6972832964247716)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(412526364442261523)
,p_plug_template_id=>wwv_flow_imp.id(6972832964247716)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(412526918011261524)
,p_plug_template_id=>wwv_flow_imp.id(6972832964247716)
,p_name=>'Sub Regions'
