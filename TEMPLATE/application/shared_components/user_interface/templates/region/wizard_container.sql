...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(6995719440247727)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(412585673395261558)
,p_plug_template_id=>wwv_flow_imp.id(6995719440247727)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(412586182856261558)
,p_plug_template_id=>wwv_flow_imp.id(6995719440247727)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(412586723242261558)
,p_plug_template_id=>wwv_flow_imp.id(6995719440247727)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(412587184349261559)
,p_plug_template_id=>wwv_flow_imp.id(6995719440247727)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(412587703797261559)
,p_plug_template_id=>wwv_flow_imp.id(6995719440247727)
