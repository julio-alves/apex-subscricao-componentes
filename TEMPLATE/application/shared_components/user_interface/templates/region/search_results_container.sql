...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(6975312511247718)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(412530548165261526)
,p_plug_template_id=>wwv_flow_imp.id(6975312511247718)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(412531081795261526)
,p_plug_template_id=>wwv_flow_imp.id(6975312511247718)
,p_name=>'Search Field'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(412531562194261526)
,p_plug_template_id=>wwv_flow_imp.id(6975312511247718)
,p_name=>'Sub Regions'
