...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(6988009563247723)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(412564719236261546)
,p_plug_template_id=>wwv_flow_imp.id(6988009563247723)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(412565212710261546)
,p_plug_template_id=>wwv_flow_imp.id(6988009563247723)
,p_name=>'Tabs'
