...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(6968159152247715)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(412513440967261516)
,p_plug_template_id=>wwv_flow_imp.id(6968159152247715)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(412513995203261516)
,p_plug_template_id=>wwv_flow_imp.id(6968159152247715)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(412514520151261517)
,p_plug_template_id=>wwv_flow_imp.id(6968159152247715)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(412515029991261517)
,p_plug_template_id=>wwv_flow_imp.id(6968159152247715)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(412515504432261517)
,p_plug_template_id=>wwv_flow_imp.id(6968159152247715)
,p_name=>'Sub Regions'
