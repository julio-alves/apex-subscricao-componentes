...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(6918267790247692)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(412385588731261438)
,p_plug_template_id=>wwv_flow_imp.id(6918267790247692)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(412386137633261439)
,p_plug_template_id=>wwv_flow_imp.id(6918267790247692)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(412386550242261439)
,p_plug_template_id=>wwv_flow_imp.id(6918267790247692)
,p_name=>'Sub Regions'
