...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(6970330592247715)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(412518109757261519)
,p_plug_template_id=>wwv_flow_imp.id(6970330592247715)
,p_name=>'Item'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(412518605566261519)
,p_plug_template_id=>wwv_flow_imp.id(6970330592247715)
,p_name=>'Button End'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(412519046548261519)
,p_plug_template_id=>wwv_flow_imp.id(6970330592247715)
,p_name=>'Button Start'
