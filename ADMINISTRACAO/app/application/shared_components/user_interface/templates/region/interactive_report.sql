...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(47866422024256355)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(47867004645256356)
,p_plug_template_id=>wwv_flow_imp.id(81999760018437452980)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(47867421783256356)
,p_plug_template_id=>wwv_flow_imp.id(81999760018437452980)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(47867945733256356)
,p_plug_template_id=>wwv_flow_imp.id(81999760018437452980)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(47868468494256356)
,p_plug_template_id=>wwv_flow_imp.id(81999760018437452980)
,p_name=>'Sub Regions'
