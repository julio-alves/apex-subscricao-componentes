...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(47721810596256266)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(47722309451256266)
,p_plug_template_id=>wwv_flow_imp.id(81999704487830452955)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(47722733259256266)
,p_plug_template_id=>wwv_flow_imp.id(81999704487830452955)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(47723290086256266)
,p_plug_template_id=>wwv_flow_imp.id(81999704487830452955)
,p_name=>'Sub Regions'
