...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(47877892704256363)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(47878405431256363)
,p_plug_template_id=>wwv_flow_imp.id(81999764692249452981)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(47878909092256363)
,p_plug_template_id=>wwv_flow_imp.id(81999764692249452981)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(47879387400256363)
,p_plug_template_id=>wwv_flow_imp.id(81999764692249452981)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(47879857184256364)
,p_plug_template_id=>wwv_flow_imp.id(81999764692249452981)
,p_name=>'Sub Regions'
