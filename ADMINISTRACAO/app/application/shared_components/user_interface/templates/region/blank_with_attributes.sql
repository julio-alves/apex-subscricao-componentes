...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(47717875348256264)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(47718400331256264)
,p_plug_template_id=>wwv_flow_imp.id(81999703091667452954)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(47718866065256264)
,p_plug_template_id=>wwv_flow_imp.id(81999703091667452954)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(47719330316256264)
,p_plug_template_id=>wwv_flow_imp.id(81999703091667452954)
,p_name=>'Sub Regions'
