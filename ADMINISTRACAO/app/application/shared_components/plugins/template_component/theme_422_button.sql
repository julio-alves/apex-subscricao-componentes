...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(48089924755256563)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(48090439405256565)
,p_plugin_id=>wwv_flow_imp.id(81999861374900453042)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(48090986722256567)
,p_plugin_id=>wwv_flow_imp.id(81999861374900453042)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(48091426764256567)
,p_plugin_id=>wwv_flow_imp.id(81999861374900453042)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(48092020108256568)
,p_plugin_id=>wwv_flow_imp.id(81999861374900453042)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(48092498813256568)
,p_plugin_id=>wwv_flow_imp.id(81999861374900453042)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(48093006071256569)
,p_plugin_id=>wwv_flow_imp.id(81999861374900453042)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(48093520656256569)
,p_plugin_id=>wwv_flow_imp.id(81999861374900453042)
,p_attribute_scope=>'COMPONENT'
