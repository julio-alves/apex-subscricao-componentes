...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(165797105355003992800)
,p_plugin_id=>wwv_flow_imp.id(81999864416232453046)
,p_title=>'Avatar'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(48094818483256571)
,p_plugin_id=>wwv_flow_imp.id(81999864416232453046)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(48095314329256572)
,p_plugin_id=>wwv_flow_imp.id(81999864416232453046)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(48095786649256572)
,p_plugin_id=>wwv_flow_imp.id(81999864416232453046)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(48096258963256573)
,p_plugin_id=>wwv_flow_imp.id(81999864416232453046)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(48096749022256575)
,p_plugin_id=>wwv_flow_imp.id(81999864416232453046)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(48103943578256591)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(165797105355003992800)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(48097309503256576)
,p_plugin_attribute_id=>wwv_flow_imp.id(48096749022256575)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(48097869624256576)
,p_plugin_attribute_id=>wwv_flow_imp.id(48096749022256575)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(48098456262256582)
,p_plugin_attribute_id=>wwv_flow_imp.id(48096749022256575)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(48099067731256583)
,p_plugin_id=>wwv_flow_imp.id(81999864416232453046)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(48096749022256575)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(48099590083256584)
,p_plugin_id=>wwv_flow_imp.id(81999864416232453046)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(48100036125256584)
,p_plugin_id=>wwv_flow_imp.id(81999864416232453046)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(48100598861256585)
,p_plugin_id=>wwv_flow_imp.id(81999864416232453046)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(48101067639256588)
,p_plugin_id=>wwv_flow_imp.id(81999864416232453046)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(48101523012256588)
,p_plugin_attribute_id=>wwv_flow_imp.id(48101067639256588)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(48102128694256589)
,p_plugin_attribute_id=>wwv_flow_imp.id(48101067639256588)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(48102736693256590)
,p_plugin_attribute_id=>wwv_flow_imp.id(48101067639256588)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(48103377478256590)
,p_plugin_attribute_id=>wwv_flow_imp.id(48101067639256588)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(48103943578256591)
,p_plugin_id=>wwv_flow_imp.id(81999864416232453046)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(48104504984256593)
,p_plugin_id=>wwv_flow_imp.id(81999864416232453046)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(48104998019256595)
,p_plugin_id=>wwv_flow_imp.id(81999864416232453046)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(48105486731256596)
,p_plugin_attribute_id=>wwv_flow_imp.id(48104998019256595)
,p_display_sequence=>10
,p_display_value=>'Basic'
,p_return_value=>'t-Comments--basic'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(48106063394256597)
,p_plugin_attribute_id=>wwv_flow_imp.id(48104998019256595)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(48106655114256599)
,p_plugin_id=>wwv_flow_imp.id(81999864416232453046)
,p_attribute_scope=>'REPORT'
