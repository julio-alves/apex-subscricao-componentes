...
@@application/shared_components/navigation/lists/menu_navegação_custom.sql
...
@@application/shared_components/files/20231118_123115374_ios_jpg.sql
@@application/plugin_settings.sql
@@application/shared_components/security/authorizations/direitos_de_administração.sql
@@application/shared_components/navigation/navigation_bar.sql
@@application/shared_components/logic/application_items/p_id_objeto_sistema.sql
@@application/shared_components/logic/application_settings.sql
@@application/shared_components/navigation/tabs/standard.sql
@@application/shared_components/navigation/tabs/parent.sql
@@application/shared_components/user_interface/lovs/lov_objeto_sistema.sql
@@application/shared_components/user_interface/lovs/lov_tipo_objeto.sql
@@application/shared_components/user_interface/lovs/lov_usuarios.sql
...
@@application/shared_components/security/authentications/controle_de_acesso_custom.sql
@@application/shared_components/plugins/template_component/theme_422_avatar.sql
@@application/shared_components/plugins/template_component/theme_422_badge.sql
@@application/shared_components/plugins/template_component/theme_422_button.sql
@@application/shared_components/plugins/template_component/theme_422_comments.sql
@@application/shared_components/plugins/template_component/theme_422_content_row.sql
@@application/shared_components/plugins/template_component/theme_422_media_list.sql
@@application/shared_components/plugins/template_component/theme_422_timeline.sql
