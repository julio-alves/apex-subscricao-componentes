...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(47706052308256256)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(47706560609256256)
,p_plug_template_id=>wwv_flow_imp.id(81999697821789452952)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(47707044505256256)
,p_plug_template_id=>wwv_flow_imp.id(81999697821789452952)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(47707523710256257)
,p_plug_template_id=>wwv_flow_imp.id(81999697821789452952)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(47708022023256257)
,p_plug_template_id=>wwv_flow_imp.id(81999697821789452952)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(47708552926256257)
,p_plug_template_id=>wwv_flow_imp.id(81999697821789452952)
,p_name=>'Sub Regions'
