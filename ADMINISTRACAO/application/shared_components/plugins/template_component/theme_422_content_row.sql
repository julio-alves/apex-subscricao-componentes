...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(165924491364934032838)
,p_plugin_id=>wwv_flow_imp.id(81999874548468453061)
,p_title=>'Avatar'
,p_display_sequence=>10
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(165924490809922032837)
,p_plugin_id=>wwv_flow_imp.id(81999874548468453061)
,p_title=>'Badge'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(165667598746191759324)
,p_plugin_id=>wwv_flow_imp.id(81999874548468453061)
,p_title=>'Appearance'
,p_display_sequence=>30
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(48112325674256619)
,p_plugin_id=>wwv_flow_imp.id(81999874548468453061)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(48112782376256619)
,p_plugin_id=>wwv_flow_imp.id(81999874548468453061)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(48113276444256620)
,p_plugin_id=>wwv_flow_imp.id(81999874548468453061)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(48113779729256621)
,p_plugin_id=>wwv_flow_imp.id(81999874548468453061)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(48114239749256622)
,p_plugin_id=>wwv_flow_imp.id(81999874548468453061)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(48114807166256622)
,p_plugin_id=>wwv_flow_imp.id(81999874548468453061)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(48115284957256623)
,p_plugin_id=>wwv_flow_imp.id(81999874548468453061)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(48114239749256622)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(165924491364934032838)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(48115793651256624)
,p_plugin_attribute_id=>wwv_flow_imp.id(48115284957256623)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(48116341547256624)
,p_plugin_attribute_id=>wwv_flow_imp.id(48115284957256623)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(48116978044256625)
,p_plugin_attribute_id=>wwv_flow_imp.id(48115284957256623)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(48117592201256628)
,p_plugin_id=>wwv_flow_imp.id(81999874548468453061)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(48115284957256623)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(48118114880256631)
,p_plugin_id=>wwv_flow_imp.id(81999874548468453061)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(48118565947256632)
,p_plugin_id=>wwv_flow_imp.id(81999874548468453061)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(48119113176256635)
,p_plugin_id=>wwv_flow_imp.id(81999874548468453061)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(48119542522256635)
,p_plugin_id=>wwv_flow_imp.id(81999874548468453061)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(48120072540256636)
,p_plugin_attribute_id=>wwv_flow_imp.id(48119542522256635)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(48120682929256638)
,p_plugin_attribute_id=>wwv_flow_imp.id(48119542522256635)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(48121284018256641)
,p_plugin_attribute_id=>wwv_flow_imp.id(48119542522256635)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(48121898842256641)
,p_plugin_attribute_id=>wwv_flow_imp.id(48119542522256635)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(48122487744256642)
,p_plugin_id=>wwv_flow_imp.id(81999874548468453061)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'RAW'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(48114807166256622)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_attribute_group_id=>wwv_flow_imp.id(165924490809922032837)
,p_help_text=>'Enter a value for the badge label or select a source column from the quick pick options.'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(48123182565256648)
,p_plugin_id=>wwv_flow_imp.id(81999874548468453061)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(48123671666256649)
,p_plugin_id=>wwv_flow_imp.id(81999874548468453061)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(48124192496256650)
,p_plugin_id=>wwv_flow_imp.id(81999874548468453061)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(48124695838256658)
,p_plugin_id=>wwv_flow_imp.id(81999874548468453061)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(48125288778256659)
,p_plugin_id=>wwv_flow_imp.id(81999874548468453061)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(48125765089256659)
,p_plugin_attribute_id=>wwv_flow_imp.id(48125288778256659)
,p_display_sequence=>10
,p_display_value=>'Subtle'
,p_return_value=>'t-Badge--subtle'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(48126384987256660)
,p_plugin_attribute_id=>wwv_flow_imp.id(48125288778256659)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(48126974841256661)
,p_plugin_id=>wwv_flow_imp.id(81999874548468453061)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(48127441841256661)
,p_plugin_attribute_id=>wwv_flow_imp.id(48126974841256661)
,p_display_sequence=>10
,p_display_value=>'Rounded'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(48128108274256662)
,p_plugin_attribute_id=>wwv_flow_imp.id(48126974841256661)
,p_display_sequence=>20
,p_display_value=>'Circular'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(48128646604256663)
,p_plugin_attribute_id=>wwv_flow_imp.id(48126974841256661)
,p_display_sequence=>30
,p_display_value=>'Square'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(48129310799256663)
,p_plugin_attribute_id=>wwv_flow_imp.id(48126974841256661)
,p_display_sequence=>40
,p_display_value=>'No Shape'
,p_return_value=>'t-Avatar--noShape'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(48129858075256665)
,p_plugin_id=>wwv_flow_imp.id(81999874548468453061)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(48130389303256666)
,p_plugin_attribute_id=>wwv_flow_imp.id(48129858075256665)
,p_display_sequence=>10
,p_display_value=>'Extra Extra Small'
,p_return_value=>'t-Avatar--xxs'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(48130993560256667)
,p_plugin_attribute_id=>wwv_flow_imp.id(48129858075256665)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(48131609441256667)
,p_plugin_attribute_id=>wwv_flow_imp.id(48129858075256665)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(48132198715256668)
,p_plugin_attribute_id=>wwv_flow_imp.id(48129858075256665)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(48132796582256668)
,p_plugin_attribute_id=>wwv_flow_imp.id(48129858075256665)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(48133348919256669)
,p_plugin_attribute_id=>wwv_flow_imp.id(48129858075256665)
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(48133995621256672)
,p_plugin_attribute_id=>wwv_flow_imp.id(48129858075256665)
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(48134609996256673)
,p_plugin_id=>wwv_flow_imp.id(81999874548468453061)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(48135021566256673)
,p_plugin_attribute_id=>wwv_flow_imp.id(48134609996256673)
,p_display_sequence=>10
,p_display_value=>'Small'
,p_return_value=>'t-Badge--sm'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(48135631362256676)
,p_plugin_attribute_id=>wwv_flow_imp.id(48134609996256673)
,p_display_sequence=>20
,p_display_value=>'Medium'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(48136318656256677)
,p_plugin_attribute_id=>wwv_flow_imp.id(48134609996256673)
,p_display_sequence=>30
,p_display_value=>'Large'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(48136844966256679)
,p_plugin_id=>wwv_flow_imp.id(81999874548468453061)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(48137517349256682)
,p_plugin_attribute_id=>wwv_flow_imp.id(48136844966256679)
,p_display_sequence=>10
,p_display_value=>'Small'
,p_return_value=>'t-ContentRow-badge--sm'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(48138052689256683)
,p_plugin_attribute_id=>wwv_flow_imp.id(48136844966256679)
,p_display_sequence=>20
,p_display_value=>'Medium'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(48138664528256684)
,p_plugin_attribute_id=>wwv_flow_imp.id(48136844966256679)
,p_display_sequence=>30
,p_display_value=>'Large'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(48139257226256686)
,p_plugin_attribute_id=>wwv_flow_imp.id(48136844966256679)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(48139833756256689)
,p_plugin_id=>wwv_flow_imp.id(81999874548468453061)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(48140410290256691)
,p_plugin_attribute_id=>wwv_flow_imp.id(48139833756256689)
,p_display_sequence=>10
,p_display_value=>'End'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(48140937156256693)
,p_plugin_id=>wwv_flow_imp.id(81999874548468453061)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(48141510303256695)
,p_plugin_attribute_id=>wwv_flow_imp.id(48140937156256693)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(48142069304256696)
,p_plugin_attribute_id=>wwv_flow_imp.id(48140937156256693)
,p_display_sequence=>20
,p_display_value=>'End'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(48142696572256697)
,p_plugin_id=>wwv_flow_imp.id(81999874548468453061)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(48143171458256697)
,p_plugin_id=>wwv_flow_imp.id(81999874548468453061)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(48143681385256698)
,p_plugin_id=>wwv_flow_imp.id(81999874548468453061)
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_attribute_group_id=>wwv_flow_imp.id(165667598746191759324)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(48144132033256699)
,p_plugin_id=>wwv_flow_imp.id(81999874548468453061)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(48144628285256700)
,p_plugin_attribute_id=>wwv_flow_imp.id(48144132033256699)
,p_display_sequence=>10
,p_display_value=>'Compact'
,p_return_value=>'t-ContentRow--styleCompact'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(48145307729256700)
,p_plugin_id=>wwv_flow_imp.id(81999874548468453061)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(48145760326256701)
,p_plugin_id=>wwv_flow_imp.id(81999874548468453061)
,p_attribute_scope=>'REPORT'
