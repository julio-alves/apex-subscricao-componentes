...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(81999902649808453097)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(165797362803085844960)
,p_plugin_id=>wwv_flow_imp.id(81999902649808453097)
,p_title=>'Avatar'
,p_display_sequence=>10
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(165797362248073844959)
,p_plugin_id=>wwv_flow_imp.id(81999902649808453097)
,p_title=>'Badge'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(48157535695256736)
,p_plugin_id=>wwv_flow_imp.id(81999902649808453097)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(48158099444256736)
,p_plugin_id=>wwv_flow_imp.id(81999902649808453097)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(48158584787256737)
,p_plugin_id=>wwv_flow_imp.id(81999902649808453097)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(48159090212256738)
,p_plugin_id=>wwv_flow_imp.id(81999902649808453097)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(48159537625256738)
,p_plugin_id=>wwv_flow_imp.id(81999902649808453097)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(48158584787256737)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(165797362803085844960)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(48160038645256739)
,p_plugin_attribute_id=>wwv_flow_imp.id(48159537625256738)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(48160688622256739)
,p_plugin_attribute_id=>wwv_flow_imp.id(48159537625256738)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(48161411684256740)
,p_plugin_attribute_id=>wwv_flow_imp.id(48159537625256738)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(48161947681256742)
,p_plugin_id=>wwv_flow_imp.id(81999902649808453097)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(48159537625256738)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(48162439059256743)
,p_plugin_id=>wwv_flow_imp.id(81999902649808453097)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(48163013323256744)
,p_plugin_id=>wwv_flow_imp.id(81999902649808453097)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(48163508316256746)
,p_plugin_id=>wwv_flow_imp.id(81999902649808453097)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(48164510998256754)
,p_plugin_id=>wwv_flow_imp.id(81999902649808453097)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(48164930526256755)
,p_plugin_attribute_id=>wwv_flow_imp.id(48164510998256754)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(48165547615256756)
,p_plugin_attribute_id=>wwv_flow_imp.id(48164510998256754)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(48166164942256757)
,p_plugin_attribute_id=>wwv_flow_imp.id(48164510998256754)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(48166731199256760)
,p_plugin_attribute_id=>wwv_flow_imp.id(48164510998256754)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(48167361005256761)
,p_plugin_id=>wwv_flow_imp.id(81999902649808453097)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'RAW'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(48159090212256738)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_attribute_group_id=>wwv_flow_imp.id(165797362248073844959)
,p_help_text=>'Enter a value for the badge label or select a source column from the quick pick options.'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(48167881537256761)
,p_plugin_id=>wwv_flow_imp.id(81999902649808453097)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(48163984638256753)
,p_plugin_id=>wwv_flow_imp.id(81999902649808453097)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(48168418152256762)
,p_plugin_id=>wwv_flow_imp.id(81999902649808453097)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(48168827287256762)
,p_plugin_id=>wwv_flow_imp.id(81999902649808453097)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(48169341987256763)
,p_plugin_id=>wwv_flow_imp.id(81999902649808453097)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(48169920109256764)
,p_plugin_attribute_id=>wwv_flow_imp.id(48169341987256763)
,p_display_sequence=>10
,p_display_value=>'Subtle'
,p_return_value=>'t-Badge--subtle'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(48170445304256764)
,p_plugin_attribute_id=>wwv_flow_imp.id(48169341987256763)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(48171078912256765)
,p_plugin_id=>wwv_flow_imp.id(81999902649808453097)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(48171599803256765)
,p_plugin_attribute_id=>wwv_flow_imp.id(48171078912256765)
,p_display_sequence=>10
,p_display_value=>'Rounded'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(48172216759256766)
,p_plugin_attribute_id=>wwv_flow_imp.id(48171078912256765)
,p_display_sequence=>20
,p_display_value=>'Circular'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(48172757794256769)
,p_plugin_attribute_id=>wwv_flow_imp.id(48171078912256765)
,p_display_sequence=>30
,p_display_value=>'Square'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(48173395886256769)
,p_plugin_id=>wwv_flow_imp.id(81999902649808453097)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(48173822200256770)
,p_plugin_attribute_id=>wwv_flow_imp.id(48173395886256769)
,p_display_sequence=>10
,p_display_value=>'2 Column Grid'
,p_return_value=>'t-MediaList--cols t-MediaList--2cols'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(48174482251256770)
,p_plugin_attribute_id=>wwv_flow_imp.id(48173395886256769)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(48175105821256771)
,p_plugin_attribute_id=>wwv_flow_imp.id(48173395886256769)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(48175716683256771)
,p_plugin_attribute_id=>wwv_flow_imp.id(48173395886256769)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(48176251376256772)
,p_plugin_attribute_id=>wwv_flow_imp.id(48173395886256769)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(48176904187256773)
,p_plugin_id=>wwv_flow_imp.id(81999902649808453097)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(48177412131256773)
,p_plugin_attribute_id=>wwv_flow_imp.id(48176904187256773)
,p_display_sequence=>10
,p_display_value=>'Large'
,p_return_value=>'t-MediaList--large force-fa-lg'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(48177951910256774)
,p_plugin_id=>wwv_flow_imp.id(81999902649808453097)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(288733546756964558232)
,p_plugin_id=>wwv_flow_imp.id(81999902649808453097)
,p_name=>'Link'
,p_static_id=>'LINK'
,p_display_sequence=>10
